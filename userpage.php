...
<body>
    ...
    <form style="float:left;margin-left:30em">
    <input type="text" size="30" id="searchbox"  placeholder="Search...">
...
?>
							<div class="card">
					    		<img class="card-img-top" src="<?php echo substr($row['image'],3);?>" alt="Card image cap" style="width:250px;height:300px">
					    		<div class="card-body">
