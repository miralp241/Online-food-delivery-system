...
<body>
	<div class="heading">
		<span style="font-size: 40px;"><img src="images/logo.png" style="width: 30px;">Delivery Login</span>
		<div class="menu">
        <button class="btn btn-primary" id="home">Home</button>
		</div>
	</div>
		<div class="body">
			<image src="delivery3.png" style="float:left;width:400px;height:400px;margin-left:300px;margin-top:100px"/>
			<div class="loginPanel">
				<form method="POST" action="includes/deliverlogin.inc.php"><?php  if($msg!=""){
